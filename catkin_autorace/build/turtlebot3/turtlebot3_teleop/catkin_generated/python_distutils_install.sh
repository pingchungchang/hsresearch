...
echo_and_run cd "/home/pcc/catkin_autorace/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/pcc/catkin_autorace/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/pcc/catkin_autorace/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
