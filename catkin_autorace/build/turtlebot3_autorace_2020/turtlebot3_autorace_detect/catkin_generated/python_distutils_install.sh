...
echo_and_run cd "/home/pcc/catkin_autorace/src/turtlebot3_autorace_2020/turtlebot3_autorace_detect"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/pcc/catkin_autorace/src/turtlebot3_autorace_2020/turtlebot3_autorace_detect/setup.py" \
     \
    build --build-base "/home/pcc/catkin_autorace/build/turtlebot3_autorace_2020/turtlebot3_autorace_detect" \
    install \
    --root="${DESTDIR-/}" \
