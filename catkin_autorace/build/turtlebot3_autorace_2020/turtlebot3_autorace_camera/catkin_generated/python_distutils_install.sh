...
echo_and_run cd "/home/pcc/catkin_autorace/src/turtlebot3_autorace_2020/turtlebot3_autorace_camera"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/pcc/catkin_autorace/src/turtlebot3_autorace_2020/turtlebot3_autorace_camera/setup.py" \
     \
    build --build-base "/home/pcc/catkin_autorace/build/turtlebot3_autorace_2020/turtlebot3_autorace_camera" \
    install \
    --root="${DESTDIR-/}" \
